...
|-----|-----------|:---:|:---:|---------|
| Unit | Jest + jsdom | 789 | 88.5% statements, 90.3% branches | `npm test -- --coverage` |
| E2E | Playwright + Chromium | 134 | — | `npm run test:e2e` |
| Accessibility | @axe-core/playwright | включены в e2e | — | |

- E2E запускаются последовательно (`workers: 1`) — избежание конфликтов localStorage.
