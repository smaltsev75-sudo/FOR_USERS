...
export const ICONS = {
    ...
    messageSquare: `<svg class="icon" ${COMMON_ATTRS}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>`,
    ...
    chevronUp: `<svg class="icon" ${COMMON_ATTRS}><path d="m18 15-6-6-6 6"/></svg>`,
    chevronDown: `<svg class="icon" ${COMMON_ATTRS}><path d="m6 9 6 6 6-6"/></svg>`,
    ...
    // Role icons (Team Capacity Dashboard, v8.21)
